    ...
    case 3:
      return {
        ...
        platforms: [
          ...
          { x: 500, y: 2800, width: 120, height: 50 },
          ...
          { x: 1300, y: 2100, width: 120, height: 50 },
          { x: 1100, y: 2000, width: 120, height: 50 },
          { x: 900, y: 1900, width: 120, height: 50 },
          ...
          { x: 1200, y: 1500, width: 120, height: 50 },
          { x: 1400, y: 1300, width: 120, height: 50 },
          { x: 1200, y: 1100, width: 120, height: 50 },
          { x: 1400, y: 900, width: 120, height: 50 },
          { x: 1200, y: 700, width: 120, height: 50 },
          { x: 1400, y: 500, width: 120, height: 50 },
          { x: 1600, y: 300, width: 120, height: 50 },
          { x: 300, y: 1600, width: 120, height: 50 },
    ...
    case 4:
      return {
        ...
        platforms: [
          ...
          { x: 900, y: 300 },
          { x: 100, y: 1700, width: 120, height: 50 },
          { x: 300, y: 1500, width: 120, height: 50 },
          { x: 100, y: 1300, width: 120, height: 50 },
          { x: 300, y: 1100, width: 120, height: 50 },
          { x: 500, y: 900, width: 120, height: 50 },
          { x: 900, y: 700, width: 120, height: 50 },
        ],
        floor: [{ x: 0, y: 1900, width: 1900, height: 40 }],
        gameFieldWidth: 1900,
        gameFieldHeight: 2000,
